package com.thirtydayskotlin.viewmodeldemo.service
...
import com.shashank.platform.moviefinder.MyApp
import com.thirtydayskotlin.viewmodeldemo.R
import com.thirtydayskotlin.viewmodeldemo.model.MovieDetail
            ...
            override fun onResponse(
                ...
                if (response.isSuccessful) {
                    ...
                    if (response.body()!!.getRatings()!!.size != 0)
                        imd.text =
                            "Internet Movie Database: " + response.body()!!.getRatings()!!.get(0).value
